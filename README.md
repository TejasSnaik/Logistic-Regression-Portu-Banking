...
In this project you will be provided with real world data which is related with
...
5) The smallest datasets are provided to test more computationally demanding machine learning algorithms (e.g., SVM).

6) The classification goal is to predict if the client will subscribe (yes/no) a term deposit (variable y).
